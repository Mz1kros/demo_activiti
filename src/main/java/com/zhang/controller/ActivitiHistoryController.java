...
public class ActivitiHistoryController {
    ...
    public ResultJson InstancesByUser() {
        try {
    ...
    public ResultJson getInstancesByPiID(@RequestParam("piID") String piID) {
        try {
    ...
    public ResultJson gethighLine(@RequestParam("instanceId") String instanceId, @AuthenticationPrincipal UserInfoBean UuserInfoBean) {
        try {
