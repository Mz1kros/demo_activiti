...
public class ProcessInstanceController {
    ...
    public ResultJson getInstances(@AuthenticationPrincipal UserInfoBean userInfoBean) {//AuthenticationPrincipal可以获取当前登录人的信息
        try {
    ...
    public ResultJson startProcess(@RequestParam("processDefinitionKey") String processDefinitionKey,
    ...
    public ResultJson deleteInstance(@RequestParam("instanceID") String instanceID) {
        try {
            if (GlobalConfig.Test) {
    ...
    public ResultJson suspendInstance(@RequestParam("instanceID") String instanceID) {
    ...
    public ResultJson resumeInstance(@RequestParam("instanceID") String instanceID) {
    ...
    public ResultJson variables(@RequestParam("instanceID") String instanceID) {
        try {
            if (GlobalConfig.Test) {
                securityUtil.logInAs("wukong");
            }
