...
public class ProcessDefinitionController {
    ...
    public ResultJson upload(HttpServletRequest request, @RequestParam("processFile") MultipartFile multipartFile) {
    ...
    public ResultJson addDeploymentByFileNameBPMN(@RequestParam("deploymentFileUUID") String deploymentFileUUID, @RequestParam("deploymentName") String deploymentName) {
        try {
    ...
    public ResultJson addDeploymentByString(@RequestParam("stringBPMN") String stringBPMN
